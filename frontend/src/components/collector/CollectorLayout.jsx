...
import { Menu, X, Home, MapPin, History, Settings, LogOut, BarChart2, User } from 'lucide-react';
...
export function CollectorLayout() {
  ...
  const navigation = [
    { name: 'Home', href: '/collector', icon: Home },
    { name: 'Routes', href: '/collector/routes', icon: MapPin },
    { name: 'History', href: '/collector/history', icon: History },
    { name: 'Analytics', href: '/collector/analytics', icon: BarChart2 },
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Main Content */}
      <div className={`lg:pl-64 transition-all duration-200 ${isSidebarOpen ? 'lg:ml-0' : 'ml-0'}`}>
        <main className="py-6">
